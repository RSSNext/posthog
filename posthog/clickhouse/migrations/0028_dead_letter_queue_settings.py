...
operations = [
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS events_dead_letter_queue_mv"),
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS kafka_events_dead_letter_queue"),
