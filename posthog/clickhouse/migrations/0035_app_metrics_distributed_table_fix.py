...
operations = [
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS app_metrics_mv"),
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS kafka_app_metrics"),
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS app_metrics"),
