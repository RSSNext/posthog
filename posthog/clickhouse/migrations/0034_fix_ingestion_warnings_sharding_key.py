...
operations = [
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS ingestion_warnings_mv"),
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS kafka_ingestion_warnings"),
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS ingestion_warnings"),
