...
class Migration(AsyncMigrationDefinition):
    ...
    operations = [
        ...
        AsyncMigrationOperationSQL(
            database=AnalyticsDBMS.CLICKHOUSE,
            sql=f"DROP TABLE person_distinct_id_mv",
            rollback=PERSONS_DISTINCT_ID_TABLE_MV_SQL,
        ),
        AsyncMigrationOperationSQL(
            database=AnalyticsDBMS.CLICKHOUSE,
            sql=f"DROP TABLE kafka_person_distinct_id",
        ...
        AsyncMigrationOperationSQL(
            ...
            rollback=f"DROP TABLE IF EXISTS kafka_person_distinct_id",
        ),
        AsyncMigrationOperationSQL(
            database=AnalyticsDBMS.CLICKHOUSE,
            sql=PERSONS_DISTINCT_ID_TABLE_MV_SQL,
            rollback=f"DROP TABLE IF EXISTS person_distinct_id_mv",
        ),
